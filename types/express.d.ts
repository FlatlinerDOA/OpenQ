declare module Express {
    ...
    export function basicAuth(username: string, password: string):any;
    export function basicAuth(authenticate: (username: string, password: string, fn?: (err, user) => any) => bool): any;
    ...
    export function cookieSession(): any;
    export function csrf(): any;
    export function directory(path:string): any;
